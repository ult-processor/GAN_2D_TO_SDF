...
from utils import *
from model_wl_concat import * 
from config import cfg


sdf_directory = './exp_results/wl_concat/chair_aba_5_10/train_samples/org/'
ply_directory = './exp_results/wl_concat/chair_aba_5_10/train_samples/ply/'
sp_directory = './exp_results/wl_concat/chair_aba_5_10/train_samples/sp/'
sz_directory = './exp_results/wl_concat/chair_aba_5_10/train_samples/sz/'
ckpt_directory = './exp_results/wl_concat/chair_aba_5_10/checkpoints/'
...
def trainGAN():
    ...
    with tf.Session(config=config) as sess:
        ...
        printout(flog, 'z_size ' + str(cfg.z_size))
