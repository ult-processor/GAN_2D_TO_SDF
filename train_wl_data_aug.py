...
sdf_directory = './local_wl_aug_data/train_samples/org/'
ply_directory = './local_wl_aug_data/train_samples/ply/'
sp_directory = './local_wl_aug_data/train_samples/sp/'
sz_directory = './local_wl_aug_data/train_samples/sz/'
ckpt_directory = './local_wl_aug_data/checkpoints/'
    ...
    with tf.Session(config=config) as sess:
        ...
        for epoch in range(cfg.n_epochs):
            ...
            for step in range(num_batch):
                ...
                rotated_pc = rotate_point_cloud(pc_train[begIdx:endIdx, ...])
                jittered_pc = jitter_point_cloud(rotated_pc)
