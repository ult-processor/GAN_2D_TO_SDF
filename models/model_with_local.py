...
def point_net_encoder(p_vector, is_training, reuse=False):
    ...
    with tf.variable_scope('encoder', reuse=reuse) as scope:
        ...
        global_feat = fully_connect(global_feat, output_size=cfg.z_size*2, name='e_gfc1')
        print(global_feat)
        global_mean = global_feat[:,:cfg.z_size]
        global_log_sigma = global_feat[:, cfg.z_size:]
        # print(global_feat)
        ...
        local_feat = fully_connect(local_feat, output_size=cfg.z_size*2, name='e_lfc1')
        print(local_feat)
        local_mean = local_feat[:,:cfg.z_size]
        local_log_sigma = local_feat[:, cfg.z_size:]
