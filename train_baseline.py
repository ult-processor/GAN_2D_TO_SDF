...
sdf_directory = './exp_results/baseline/chair/train_samples/org/'
ply_directory = './exp_results/baseline/chair/train_samples/ply/'
sp_directory = './exp_results/baseline/chair/train_samples/sp/'
sz_directory = './exp_results/baseline/chair/train_samples/sz/'
ckpt_directory = './exp_results/baseline/chair/checkpoints/'
...
def trainGAN():
    ...
    e_vars = [var for var in t_vars if any(name in var.name for name in ['encoder', 'e_'])]
